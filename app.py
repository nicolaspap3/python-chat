...
# python dict. Store connexted users. Key is socketid, value is username and avatarUrl
users = {}
...
def handle_message(data):
    ...
    if user:
        emit("new_message", {
             "username": user["username"], "avatar": user["avatar"], "message": data["message"]}, broadcast=True)
